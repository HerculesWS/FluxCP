...
<form action="<?php echo htmlspecialchars($this->url) ?>" method="get" class="search-form">
	...
	<p>
		...
		<input type="text" name="id" id="id" value="<?php echo htmlspecialchars((string)$params->get('id')) ?>" />
		...
		<label for="guild_name">Guild Name:</label>
		<input type="text" name="guild_name" id="guild_name" value="<?php echo htmlspecialchars((string)$params->get('guild_name')) ?>" />
		...
		...
		<input type="text" name="master" id="master" value="<?php echo htmlspecialchars((string)$params->get('master')) ?>" />
	</p>
	<p>
		...
		<input type="text" name="guild_level" id="guild_level" value="<?php echo htmlspecialchars((string)$params->get('guild_level')) ?>" />
		...
		...
		<input type="text" name="connect_member" id="connect_member" value="<?php echo htmlspecialchars((string)$params->get('connect_member')) ?>" />
		...
		...
		<input type="text" name="max_member" id="max_member" value="<?php echo htmlspecialchars((string)$params->get('max_member')) ?>" />
	</p>
	<p>
		...
		<input type="text" name="average_lv" id="average_lv" value="<?php echo htmlspecialchars((string)$params->get('average_lv')) ?>" />
