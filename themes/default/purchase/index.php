	...
	<tr>
		...
		<td>
			...
			<p class="shop-item-action">
				...
				/ <a href="<?php echo htmlspecialchars($this->url('itemshop', 'edit', array('id' => $item->shop_item_id))) ?>">Modify</a>
				<?php endif ?>
				<?php if ($auth->allowedToDeleteShopItem): ?>
				/ <a href="<?php echo htmlspecialchars($this->url('itemshop', 'delete', array('id' => $item->shop_item_id, 'Session' => Flux_Security::csrfGet('Session')))) ?>"
