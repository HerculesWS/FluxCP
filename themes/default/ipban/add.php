...
<form action="<?php echo $this->urlWithQs ?>" method="post" class="generic-form">
	...
	<table class="generic-form-table">
		<tr>
			...
			<td><input type="text" name="list" id="list" value="<?php echo htmlspecialchars((string)$params->get('list')) ?>" /></td>
		...
		<tr>
			...
			<td>
				<textarea name="reason" id="reason" class="reason"><?php echo htmlspecialchars((string)$params->get('reason')) ?></textarea>
			</td>
			<td></td>
		</tr>
		<tr>
