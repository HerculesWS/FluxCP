...
<form action="<?php echo htmlspecialchars($this->url) ?>" method="post" class="generic-form">
	...
	<table class="generic-form-table">
		...
		<tr>
			...
			<td><input type="text" name="username" id="register_username" value="<?php echo htmlspecialchars((string)$params->get('username')) ?>" /></td>
		</tr>
		...
		<tr>
			...
			<td><input type="text" name="email_address" id="register_email_address" value="<?php echo htmlspecialchars((string)$params->get('email_address')) ?>" /></td>
		</tr>
