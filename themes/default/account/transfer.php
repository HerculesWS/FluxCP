...
<form action="<?php echo htmlspecialchars($this->url) ?>" method="post" class="generic-form">
	...
	<table class="generic-form-table">
		<tr>
			...
			<td><input type="text" name="credits" id="credits" value="<?php echo htmlspecialchars((string)$params->get('credits')) ?>" /></td>
		...
		<tr>
			...
			<td><input type="text" name="char_name" id="char_name" value="<?php echo htmlspecialchars((string)$params->get('char_name')) ?>" /></td>
