...
<form action="<?php echo htmlspecialchars($this->url) ?>" method="get" class="search-form">
	...
	<p>
		...
		<input type="text" name="account_id" id="account_id" value="<?php echo htmlspecialchars((string)$params->get('account_id')) ?>" />
		...
		...
		<input type="text" name="request_ip" id="request_ip" value="<?php echo htmlspecialchars((string)$params->get('request_ip')) ?>" />
		...
		<label for="reset_ip">Reset IP:</label>
		<input type="text" name="reset_ip" id="reset_ip" value="<?php echo htmlspecialchars((string)$params->get('reset_ip')) ?>" />
	...
	<p>
		...
		<input type="text" name="old_password" id="old_password" value="<?php echo htmlspecialchars((string)$params->get('old_password')) ?>" />
		...
		<label for="new_password">New Password:</label>
		<input type="text" name="new_password" id="new_password" value="<?php echo htmlspecialchars((string)$params->get('new_password')) ?>" />
