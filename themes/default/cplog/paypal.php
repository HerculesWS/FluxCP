...
<form action="<?php echo htmlspecialchars($this->url) ?>" method="get" class="search-form">
	...
	<p>
		...
		<input type="text" name="txn_id" id="txn_id" value="<?php echo htmlspecialchars((string)$params->get('txn_id')) ?>" />
		...
		<label for="parent_txn_id">Parent Transaction ID:</label>
		<input type="text" name="parent_txn_id" id="parent_txn_id" value="<?php echo htmlspecialchars((string)$params->get('parent_txn_id')) ?>" />
		...
		<label for="status">Status:</label>
		<input type="text" name="status" id="status" value="<?php echo htmlspecialchars((string)$params->get('status')) ?>" />
		...
	...
	<p>
		...
		<input type="text" name="amount" id="amount" value="<?php echo htmlspecialchars((string)$params->get('amount')) ?>" />
		...
