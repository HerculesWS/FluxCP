...
<form action="<?php echo htmlspecialchars($this->url) ?>" method="get" class="search-form">
	...
	<p>
		...
		<input type="text" name="change_ip" id="change_ip" value="<?php echo htmlspecialchars((string)$params->get('change_ip')) ?>" />
	</p>
	<p>
		<label for="old_email">Old Email:</label>
		<input type="text" name="old_email" id="old_email" value="<?php echo htmlspecialchars((string)$params->get('old_email')) ?>" />
		...
		<label for="new_email">New Email:</label>
		<input type="text" name="new_email" id="new_email" value="<?php echo htmlspecialchars((string)$params->get('new_email')) ?>" />
