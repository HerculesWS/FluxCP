...
<form class="search-form" method="get">
	...
	<p>
		...
		<input type="text" name="monster_id" id="monster_id" value="<?php echo htmlspecialchars((string)$params->get('monster_id')) ?>" />
		...
		...
		<select name="mvp" id="mvp">
			<option value="all"<?php if (!($mvpParam=strtolower((string)$params->get('mvp'))) || $mvpParam == 'all') echo ' selected="selected"' ?>>All</option>
	...
	<p>
		...
		<input type="text" name="card_id" id="card_id" value="<?php echo htmlspecialchars((string)$params->get('card_id')) ?>" />
		...
