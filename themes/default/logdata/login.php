...
<form action="<?php echo htmlspecialchars($this->url) ?>" method="get" class="search-form">
	...
	<p>
		...
		<input type="text" name="ip" id="ip" value="<?php echo htmlspecialchars((string)$params->get('ip')) ?>" />
		...
		<label for="user">Username:</label>
		<input type="text" name="user" id="user" value="<?php echo htmlspecialchars((string)$params->get('user')) ?>" />
		...
		<label for="log">Log Message:</label>
		<input type="text" name="log" id="log" value="<?php echo htmlspecialchars((string)$params->get('log')) ?>" />
		...
		<label for="rcode">Response:</label>
		<input type="text" name="rcode" id="rcode" value="<?php echo htmlspecialchars((string)$params->get('rcode')) ?>" />
