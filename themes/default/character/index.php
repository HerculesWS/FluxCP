...
<form action="<?php echo htmlspecialchars($this->url) ?>" method="get" class="search-form">
	...
	<p>
		...
		<input type="text" name="char_id" id="char_id" value="<?php echo htmlspecialchars((string)$params->get('char_id')) ?>" />
		...
		<label for="account">Account:</label>
		<input type="text" name="account" id="account" value="<?php echo htmlspecialchars((string)$params->get('account')) ?>" />
		...
		...
		<input type="text" name="char_class" id="char_class" value="<?php echo htmlspecialchars((string)$params->get('char_class')) ?>" />
	</p>
	<p>
		...
		<input type="text" name="base_level" id="base_level" value="<?php echo htmlspecialchars((string)$params->get('base_level')) ?>" />
		...
		...
		<input type="text" name="job_level" id="job_level" value="<?php echo htmlspecialchars((string)$params->get('job_level')) ?>" />
		...
		...
		<input type="text" name="zeny" id="zeny" value="<?php echo htmlspecialchars((string)$params->get('zeny')) ?>" />
	</p>
	<p>
		<label for="guild">Guild:</label>
		<input type="text" name="guild" id="guild" value="<?php echo htmlspecialchars((string)$params->get('guild')) ?>" />
		...
		<label for="partner">Partner:</label>
		<input type="text" name="partner" id="partner" value="<?php echo htmlspecialchars((string)$params->get('partner')) ?>" />
		...
		<label for="mother">Mother:</label>
		<input type="text" name="mother" id="mother" value="<?php echo htmlspecialchars((string)$params->get('mother')) ?>" />
		...
		<label for="father">Father:</label>
		<input type="text" name="father" id="father" value="<?php echo htmlspecialchars((string)$params->get('father')) ?>" />
		...
		<label for="child">Child:</label>
		<input type="text" name="child" id="child" value="<?php echo htmlspecialchars((string)$params->get('child')) ?>" />
	</p>
	<p>	
		...
		<input type="text" name="slot" id="slot" value="<?php echo htmlspecialchars((string)$params->get('slot')) ?>" />
