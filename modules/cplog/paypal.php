...
$txnID           = trim((string)$params->get('txn_id'));
$parentTxnID     = trim((string)$params->get('parent_txn_id'));
$paymentStatus   = trim((string)$params->get('status'));
$emailAddress    = trim((string)$params->get('email'));
